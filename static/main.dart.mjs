...
_1815: x0 => x0.pop(),
_1819: (x0,x1,x2) => x0[x1] = x2,
_1821: o => o === undefined,
_1822: o => typeof o === 'boolean',
_1823: o => typeof o === 'number',
_1825: o => typeof o === 'string',
_1828: o => o instanceof Int8Array,
_1829: o => o instanceof Uint8Array,
_1830: o => o instanceof Uint8ClampedArray,
_1831: o => o instanceof Int16Array,
_1832: o => o instanceof Uint16Array,
_1833: o => o instanceof Int32Array,
_1834: o => o instanceof Uint32Array,
_1835: o => o instanceof Float32Array,
_1836: o => o instanceof Float64Array,
_1837: o => o instanceof ArrayBuffer,
_1838: o => o instanceof DataView,
_1839: o => o instanceof Array,
_1840: o => typeof o === 'function' && o[jsWrappedDartFunctionSymbol] === true,
_1842: o => {
            const proto = Object.getPrototypeOf(o);
            return proto === Object.prototype || proto === null;
          },
_1843: o => o instanceof RegExp,
_1844: (l, r) => l === r,
_1845: o => o,
_1846: o => o,
_1847: o => o,
...
_1849: o => o.length,
_1852: (o, i) => o[i],
_1853: f => f.dartFunction,
_1854: l => arrayFromDartList(Int8Array, l),
_1855: (data, length) => {
...
_1856: l => arrayFromDartList(Uint8ClampedArray, l),
_1857: l => arrayFromDartList(Int16Array, l),
_1858: l => arrayFromDartList(Uint16Array, l),
_1859: l => arrayFromDartList(Int32Array, l),
_1860: l => arrayFromDartList(Uint32Array, l),
_1861: l => arrayFromDartList(Float32Array, l),
_1862: l => arrayFromDartList(Float64Array, l),
_1863: (data, length) => {
...
_1864: l => arrayFromDartList(Array, l),
_1865:       (s, length) => {
        if (length == 0) return '';
...
_1874: (o, p) => o[p],
_1875: (o, p, v) => o[p] = v,
_1876: (o, m, a) => o[m].apply(o, a),
_1878: o => String(o),
_1879: (p, s, f) => p.then(s, f),
_1880: s => {
      if (/[[\]{}()*+?.\\^$|]/.test(s)) {
          s = s.replace(/[[\]{}()*+?.\\^$|]/g, '\\$&');
      }
...
_1887: (x0,x1) => x0[x1],
_1890: x0 => x0.flags,
_1891: x0 => x0.multiline,
_1892: x0 => x0.ignoreCase,
_1893: x0 => x0.unicode,
_1894: x0 => x0.dotAll,
_1895: (x0,x1) => x0.lastIndex = x1,
